...
export const servicesPageData = [
    ...
    {
        id: "servicios-futuro",
        title: "Servicios a futuro",
        iconName: "sparkles",
        description: "Mirando hacia adelante, expandimos nuestras capacidades para ofrecer soluciones innovadoras que anticipan las necesidades del mañana.",
        imageSrc: "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80",
        imageAlt: "Concepto abstracto de diseño futurista y sostenible.",
        imagePosition: "right",
        bulletPoints: [
            "Diseño de muebles",
        ...
        cta: {
            text: "Explorar Innovaciones",
            link: "/metas-innovacion"
        }
    }
];